...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { amount: @bet.amount, game_id: @bet.game_id, user_id: @bet.user_id, wager_on: @bet.wager_on }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { amount: @bet.amount, game_id: @bet.game_id, user_id: @bet.user_id, wager_on: @bet.wager_on }
    assert_redirected_to bet_path(assigns(:bet))
  end
