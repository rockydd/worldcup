...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { name: @rank.name, rank: @rank.rank, user_id: @rank.user_id, value: @rank.value }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { name: @rank.name, rank: @rank.rank, user_id: @rank.user_id, value: @rank.value }
    assert_redirected_to rank_path(assigns(:rank))
  end
